    ...
    <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
      ...
      <div class="navbar-header">
        ...
        <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
          <img class="navbar-brand-logo" src="{{ asset('admin/assets/images/logo.png') }}" title="Remark">
              ...
              <div class="card-block bg-white table-responsive">
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <img src="{{ asset('admin/assets/examples/images/products/imac.png') }}"
                          alt="iMac" />
                      </td>
                      <td>iMac</td>
                      <td>Russell</td>
                    ...
                    <tr>
                      <td>
                        <img src="{{ asset('admin/assets/examples/images/products/iphone.png') }}"
                          alt="iPhone" />
                      </td>
                      <td>iPhone</td>
                      <td>Carol</td>
                    ...
                    <tr>
                      <td>
                        <img src="{{ asset('admin/assets/examples/images/products/applewatch.png') }}"
                          alt="apple_watch" />
                      </td>
                      <td>apple Watch</td>
                      <td>Austin Pena</td>
                    ...
                    <tr>
                      <td>
                        <img src="{{ asset('admin/assets/examples/images/products/macmouse.png') }}"
                          alt="mac_mouse" />
                      </td>
                      <td>mac Mouse</td>
                      <td>Randy</td>
